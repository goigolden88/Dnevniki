 ...
 *
 * Отделены от `core/cycles.ts` намеренно: там расчёт, здесь подача.
 * Ядро не знает, что его читают глазами, и русских строк не содержит.
 */

import type { CycleState, CycleStatus } from '../../core/cycles.ts'
