...
export const cycleImportSpec: ImportSpec = {
  ...
  fields: [
    ...
    '"marks" — когда делал: [{ "date": "ГГГГ-ММ-ДД", "price": 700 }]; "price" — цена в рублях, если есть',
  ],
  example: [
    { name: 'Стрижка', cat: 'Гигиена', marks: [{ date: '2026-01-24', price: 700 }, { date: '2026-03-02' }] },
    {
      name: 'Картридж, 1-я стадия',
      cat: 'Дом',
      group: 'Фильтр для воды',
      intervalDays: 180,
      marks: [{ date: '2026-02-10', price: 1089 }],
    },
  ],
}
