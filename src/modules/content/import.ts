...
export const contentImportSpec: ImportSpec = {
  ...
  fields: [
    ...
    `"score" — оценка от ${SCORE_MIN} до ${SCORE_MAX}, можно с одним знаком после точки. ` +
      `Пять звёзд умножай на ${SCORE_MAX / 5}, сто баллов дели на ${100 / SCORE_MAX}; нет оценки — не писать`,
