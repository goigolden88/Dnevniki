  ...
  return (
    <>
      ...
      {content.entries.length === 0 && (
        <p className="stub">
          Здесь то, что смотришь, читаешь, во что играешь и чему учишься. «Добавить запись» — по
          умолчанию «смотрю» с этим месяцем; досмотрел — поставь оценку, и запись уйдёт в итоги года.
          Что посмотреть потом — статус «к просмотру».
        </p>
      )}
