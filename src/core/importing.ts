...
export function buildPrompt(specs: readonly ImportSpec[], day: DateStr): string {
  ...
  return [
    ...
    '3. Статусы из других сервисов: смотрю, читаю, играю, прохожу, отложено → "active"; просмотрено, ' +
      'прочитано, пройдено → "done"; брошено → "dropped"; запланировано, хочу посмотреть → "planned".',
    '4. Скриншоты списков — Шикимори, MyAnimeList, Кинопоиск, Letterboxd, Steam и похожие: бери ' +
