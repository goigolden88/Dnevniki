/**
 * Первый запуск (Р-69): пуста ли база и что показать новому человеку.
 *
...
/**
 * Где лежат записи человека. Категории, теги и шаблоны не в счёт:
 * категории заводятся сами при первом запуске (Р-59), теги и шаблоны —
 * только вслед за записями.
 */
...
/**
 * Строка про установку на iPhone во вкладке Safari (Р-69).
 *
