...
const SHAPES = [
  // Корешок тетради
  { x: 118, y: 118, w: 16, h: 276, r: 8, color: [0x6f, 0x9d, 0xff], alpha: 1 },
  // Строки записей
  { x: 166, y: 150, w: 228, h: 18, r: 9, color: [0xec, 0xec, 0xee], alpha: 1 },
  { x: 166, y: 212, w: 164, h: 18, r: 9, color: [0xec, 0xec, 0xee], alpha: 0.72 },
  { x: 166, y: 274, w: 196, h: 18, r: 9, color: [0xec, 0xec, 0xee], alpha: 0.52 },
  { x: 166, y: 336, w: 120, h: 18, r: 9, color: [0xec, 0xec, 0xee], alpha: 0.32 },
]
